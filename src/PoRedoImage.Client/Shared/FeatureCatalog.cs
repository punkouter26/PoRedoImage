...
/// <summary>One transformation the Studio offers, as shown on a card and in cross-feature links.</summary>
/// <param name="Route">The page's canonical <c>@page</c> route.</param>
/// <param name="Emoji">Card glyph.</param>
/// <param name="Icon">Bootstrap-icon class used in dense contexts (buttons, chips).</param>
...
public static class FeatureCatalog
{
    ...
    [
        ...
        new("/meme-generation", "Meme", "😂", "bi-emoji-laughing",
            "AI writes a witty caption and overlays it on your image."),
        new("/bulk-generate", "Bulk Generate", "🖼️", "bi-collection",
        ...
        new("/style-director", "Style Director", "✨", "bi-stars",

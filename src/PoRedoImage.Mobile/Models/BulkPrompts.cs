...
/// <summary>
/// Default Category 1 art-style transformation prompts for Bulk Generate — the same ten the web
/// client ships in <c>PoRedoImage.Client/Models/DefaultPrompts.cs</c>. The mobile head references
/// only <c>PoRedoImage.Shared</c>, so the list is mirrored here; if you change one, change both.
/// </summary>
/// <remarks>
/// Each prompt contains <c>&lt;PERSON&gt;</c> as a placeholder replaced at generation time with
/// the AI's description of the subject in the uploaded image. The joke is always the collision
/// between a wildly overblown medium and a mundane subject, never the person themselves.
/// </remarks>
public static class BulkPrompts
{
    /// <summary>Token that gets substituted with the vision description of the uploaded image.</summary>
